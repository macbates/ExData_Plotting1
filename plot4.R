#
# Coursera EDA course project 1 - plot4.R
#
...
# Top left
plot(d$newDate, d$Global_active_power, type="l", ylab = "Global Active Power", xlab = "")

# Top right
plot(d$newDate, d$Voltage, type = "l", ylab = "Voltage", xlab = "datetime")
...
# Bottom right
plot(d$newDate, d$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "datetime")
dev.off()
